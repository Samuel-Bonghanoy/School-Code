    ...
    <div className="flex gap-[20rem] justify-center pt-10 bg-cyan-100">
      <div className="flex flex-col items-center justify-start">
        ...
        <List
          ...
          sx={{ width: "100%", maxWidth: 360, bgcolor: "#cffafe" }}
        >
          {bus1Passengers.map((p) => (
            <ListItem key={p.id}>
              <ListItemAvatar>
                <Avatar>
              ...
              <ListItemText
                ...
                secondary={p.destination.destination}
              />
            </ListItem>
          ))}
        </List>
      ...
      <div className="flex flex-col items-center justify-start">
        <div className="flex items-center gap-2">
          <DirectionsBusIcon />
          <h2 className="font-bold text-2xl text-center justify-start">
            Bus 2
          </h2>
        </div>
        <List
