...
FILE readFile(FILE *fp, List **buffer, int count);
FILE writeFile(FILE *fp, List **buffer, int count);
FILE updateFile(FILE *fp, List buffer, int count);
